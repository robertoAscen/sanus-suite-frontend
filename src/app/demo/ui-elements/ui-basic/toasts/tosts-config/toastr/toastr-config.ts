...
export interface IndividualConfig {
   ...
   * default: Toast
   */
  toastComponent?: ComponentType<void>;
  /**
...
export class ToastPackage {
  ...
  triggerAction(action?: null): void {
...
export type GlobalToastrConfig = GlobalConfig;
/** @deprecated use IndividualConfig */
export type IndividualToastrConfig = IndividualConfig;
/** @deprecated use IndividualConfig */
export type ToastrConfig = IndividualConfig;
